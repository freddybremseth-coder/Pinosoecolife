...
export const ecoLifeAreas: EcoLifeArea[] = [
  ...
  },
  {
    ...
    story: [
      ...
      "For deg som er nysgjerrig på innlandet, men ikke vil gå rett til de dypeste delene av provinsen, kan Hondón være et naturlig sted å begynne sammenligningen.",
    ],
